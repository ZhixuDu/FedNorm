...
def args_parser():
    ...
    # other arguments
    parser.add_argument('--cvt_shift', type=int, default=0, help="whether colorjitter to increase covariates shifts")
    parser.add_argument('--restriction', type=str, default='mean+std', help="whether colorjitter to increase covariates shifts")
    ...
    parser = helper.add_util_parser(parser)
